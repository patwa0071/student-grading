...
public class GraderTest {
    ...
    public void itShouldParseInputTestDataIntoStudents() throws IOException {
    ...
    public void itShouldCalculateStudentGradeAndFinalScore() throws IOException {
        String filepath = Paths.get("src", "test", "resources", "grades.csv").toString();
        List<Student> students = grader.parseCSV(filepath);
    ...
    public void itShouldFindOverallTopperStudent() throws IOException {
        String filepath = Paths.get("src", "test", "resources", "grades.csv").toString();
        List<Student> students = grader.parseCSV(filepath);
        List<Student> gradedStudents = grader.calculateGrade(students);
    ...
    public void itShouldFindTopperStudentForEachUniversity() throws IOException {
        String filepath = Paths.get("src", "test", "resources", "grades.csv").toString();
        List<Student> students = grader.parseCSV(filepath);
        List<Student> gradedStudents = grader.calculateGrade(students);
